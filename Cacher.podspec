...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Aashish Tamsya" => "aashish.tamsya@gmail.com" }
  # Or just: spec.author    = "Aashish Tamsya"
  # spec.authors            = { "Aashish Tamsya" => "aashish.tamsya@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/ChiefAashish"
